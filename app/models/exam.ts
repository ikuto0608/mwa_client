  ...
  toJson(): any {
    ...
    if (this.topics) {
      this.topics.forEach((topic) => {
        topics.push({ id: topic.id, question: topic.question, description: topic.description, question_array: topic.questionArray, index_array_of_answer: topic.indexOfAnswerArray });
      });
    }
